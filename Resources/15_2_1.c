...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/13 17:35:16 by pbiederm          #+#    #+#             */
/*   Updated: 2022/10/13 17:43:08 by pbiederm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main (int argc, char **argv)
{
	...
	int result2 = pthread_create(&thread1, NULL, thread_body, str2);
	int result3 = pthread_create(&thread1, NULL, thread_body, str3);
