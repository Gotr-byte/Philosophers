...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/13 11:47:20 by pbiederm          #+#    #+#             */
/*   Updated: 2022/10/13 12:07:08 by pbiederm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void *thread_body_1(void *arg)
{
	...
	printf("A\n");
	ss->done = TRUE;
	// Signal the thread waiting on the condition variable
